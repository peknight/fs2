...
trait PullStateErrorDsl[I, O, S, E] extends PullStateDsl[I, O, S, E]:
  ...
  def liftPET[F[_], A](pull: Pull[F, O, Either[Throwable, A]]): PS[F, A] =
    super.liftPET(pull)(error)
  def liftPLT[F[_], A](pull: Pull[F, O, Throwable]): PS[F, A] =
